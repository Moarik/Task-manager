...
import (
	...
	"log"
	"net"
	"taskManager/user/internal/adapter/grpc/service/user"
...
func New(cfg config.GRPCServer, userUsecase UserUsecase) *API {
	return &API{
		cfg:         cfg,
...
func (a *API) run(ctx context.Context) error {
	...
	userSvc.RegisterUserServiceServer(a.s, user.New(a.userUsecase))
