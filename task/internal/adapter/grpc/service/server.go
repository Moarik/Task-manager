...
import (
	...
	"log"
	"net"
	"taskManager/task/internal/adapter/grpc/service/task"
...
func New(cfg config.GRPCServer, taskUsecase TaskUsecase) *API {
	return &API{
		cfg:         cfg,
...
func (a *API) run(ctx context.Context) error {
	...
	taskSvc.RegisterTaskServiceServer(a.s, task.New(a.taskUsecase))
